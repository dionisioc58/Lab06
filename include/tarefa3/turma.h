 ...
 */
    ...
    */  
    ...
    public:
        ...
        Aluno *getAlunos();                                 /**< Retorna a lista de alunos */
        void setAlunos(Aluno *f, int n);                    /**< Modifica a lista de alunos */
        bool addAluno(Aluno *f);                            /**< Adiciona um aluno */
        bool delAluno(int f);                               /**< Remove um aluno */
        bool pertenceTurma(string n);                       /**< Verifica se um nome pertence à lista de aluno */
